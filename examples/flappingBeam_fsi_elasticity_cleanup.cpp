...
template<class T>
void initializeSolidSolver(T timeStep);
...
//         initializeSolidSolver(patches, timeStep);  // Turek-Hron FSI 3 时间步长
//         firstCall = false;
...
//     }
                ...
                // 从这里重写update geometry boundary, 开始传样条
                //-----------------------------------------边界位移更新------------------------------------
                ...
                gsInfo << "Updating boundary displacements for fluid interfaces...\n";  
            ...
            //    }
               ...
               // TODO: Fix displacement function usage
               // currentPatches.setCoefs(currentPatches.coefs() + 
               //                        displacementFunc.function(0).eval(currentPatches.points()));

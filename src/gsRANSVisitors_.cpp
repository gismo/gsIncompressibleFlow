...
namespace gismo
{
    ...
    CLASS_TEMPLATE_INST gsRANSVisitorSUPGStabilization_diffusion<real_t, RowMajor>;
    CLASS_TEMPLATE_INST gsRANSVisitorSUPGStabilization_presssure<real_t, RowMajor>;
    ...
    CLASS_TEMPLATE_INST gsRANSVisitorSUPGStabilization_diffusion<real_t, ColMajor>;
    CLASS_TEMPLATE_INST gsRANSVisitorSUPGStabilization_presssure<real_t, ColMajor>;

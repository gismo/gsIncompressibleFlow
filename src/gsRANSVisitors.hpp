...
// ================================================================================================================
// For T-CSD and SUPG stabilization
//
...
void gsRANSVisitorTCSDStabilization_time<T, MatOrder>::evaluate(index_t testFunID)
{
    ...
    gsMatrix<T> velocities = m_solutionField.value(m_quNodes);
...
template <class T, int MatOrder>
void gsRANSVisitorSUPGStabilization_diffusion<T, MatOrder>::initMembers()
{
    m_viscosity = m_paramsPtr->getPde().viscosity();
}

template <class T, int MatOrder>
void gsRANSVisitorSUPGStabilization_diffusion<T, MatOrder>::evaluate(index_t testFunID)
{
    Base::evaluate(testFunID);
    ...
    gsFlowTerm_SUPGStabilization_diffusion<T>* termPtr = dynamic_cast< gsFlowTerm_SUPGStabilization_diffusion<T>* > (m_terms.back());
    if (termPtr)
    {
        termPtr->setTauS(m_tauS);
        termPtr->setUSolVals(velocities);
...
template <class T, int MatOrder>
void gsRANSVisitorSUPGStabilization_diffusion<T, MatOrder>::evaluate(const gsDomainIterator<T>* domIt)
{
    Base::evaluate(domIt);
    ...
    gsFlowTerm_SUPGStabilization_diffusion<T>* termPtr = dynamic_cast< gsFlowTerm_SUPGStabilization_diffusion<T>* > (m_terms[0]);
    if (termPtr)
    {
        termPtr->setTauS(m_tauS);
        termPtr->setUSolVals(velocities);
    ...
    /*gsRANSTerm_SG_SUPGstabilization_diffusion<T>* term2Ptr = dynamic_cast< gsRANSTerm_SG_SUPGstabilization_diffusion<T>* > (m_terms[1]);
    if (term2Ptr)
    {
        term2Ptr->setTauS(m_tauS);
        term2Ptr->setUSolVals(velocities);
        term2Ptr->setTurbulentViscosityVals(m_TurbulentViscosityVals);
        term2Ptr->setTurbulentViscosityGrads(m_TurbulentViscosityGrads);
    }*/
}
...
template <class T, int MatOrder>
void gsRANSVisitorSUPGStabilization_presssure<T, MatOrder>::evaluate(index_t testFunID)
{
    Base::evaluate(testFunID);
    ...
    gsRANSTerm_SUPGstabilization_pressure<T>* termPtr = dynamic_cast< gsRANSTerm_SUPGstabilization_pressure<T>* > (m_terms.back());
    if (termPtr)
    {
        termPtr->setTauS(m_tauS);
        termPtr->setUSolVals(velocities);
...
template <class T, int MatOrder>
void gsRANSVisitorSUPGStabilization_presssure<T, MatOrder>::evaluate(const gsDomainIterator<T>* domIt)
{
    Base::evaluate(domIt);

...
public: // *** Getters/setters ***
    ...
    void setRANSsolutionField(gsField<T>& solution) { m_solutionField = solution;}
...
template <class T, int MatOrder>
class gsRANSVisitorSUPGStabilization_diffusion : public gsRANSVisitorUU<T, MatOrder>
{
...
public: // *** Constructor/destructor ***
    ...
    gsRANSVisitorSUPGStabilization_diffusion() {}

    gsRANSVisitorSUPGStabilization_diffusion(typename gsFlowSolverParams<T>::Ptr paramsPtr) :
    Base(paramsPtr)
    {   }

    /// @brief Copy constructor.
    gsRANSVisitorSUPGStabilization_diffusion(gsRANSVisitorSUPGStabilization_diffusion<T, MatOrder> const & other) :
    gsRANSVisitorSUPGStabilization_diffusion()
    {
        // shallow copy of all members
        *this = other;
...
protected: // *** Member functions ***
    ...
    virtual void defineTerms()
    {
        ...
        //m_terms.push_back( new gsRANSTerm_SG_SUPGstabilization_diffusion<T>() );
    }
...
template <class T, int MatOrder>
class gsRANSVisitorSUPGStabilization_presssure : public gsINSVisitorPU<T, MatOrder>
{
...
public: // *** Constructor/destructor ***
    ...
    gsRANSVisitorSUPGStabilization_presssure() {}

    gsRANSVisitorSUPGStabilization_presssure(typename gsFlowSolverParams<T>::Ptr paramsPtr) :
    Base(paramsPtr)
    {   }

    /// @brief Copy constructor.
    gsRANSVisitorSUPGStabilization_presssure(gsRANSVisitorSUPGStabilization_presssure<T, MatOrder> const & other) :
    gsRANSVisitorSUPGStabilization_presssure()
    {
        // shallow copy of all members
        *this = other;
...
protected: // *** Member functions ***
    ...
    virtual void defineTerms()
    {
        m_terms.push_back( new gsRANSTerm_SUPGstabilization_pressure<T>() );
    }
